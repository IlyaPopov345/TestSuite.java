...
public class GeodesySuite {
    ...
    public void forwardTaskTest() {
        ...
        Assert.assertEquals(4.3301, direction.distance, 0.0001);
        Assert.assertEquals(2.5000, direction.distance, 0.0001);
        Assert.assertEquals(5.3301, direction.angle, 0.0001);
        Assert.assertEquals(3.5000, direction.angle, 0.0001);
